...
* Subset Selection Methods (best subset/ forward/ backward stepwise): 10-fold cv to get the min MSE ---> refit the data w/ all the data ---> get the coef w/ suitable n of predictor
* 
