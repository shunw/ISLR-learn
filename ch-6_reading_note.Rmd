...
1. glmnet(x, y, alpha = 0, lambda = some_value or a_set_of_value): to get the ridge coef based the lambda value 
  ...
  * predict(glmnet.mod, s = lambda_value, newx = x[test, ]): to get ridge coef with new lambda value based on the same glmnet.mod
2. cv.glmnet(x, y, alpha = 0): to choose/ get the min lambda by checking with the 10 fold cross validation. 
...
in the line of 'In general, if we want to fit a (unpenalized) xxx. '
